...
export class ZillaPlusSecurePublicAccessStack extends TerraformStack {
  ...
  constructor(scope: Construct, id: string) {
    ...
    const bootstrapServers = 
      mskClientAuthentication === "mTLS" ? mskCluster.bootstrapBrokersTls :
      mskClientAuthentication === "SASL/SCRAM" ? mskCluster.bootstrapBrokersSaslScram :
      mskCluster.bootstrapBrokers;
    ...
    if (mskClientAuthentication === 'mTLS')
    {
      ...
      const PUBLIC_CERTIFICATE_AUTHORITY = process.env.PUBLIC_CERTIFICATE_AUTHORITY === "true";

...
class ZillaPlusIotAndControlStack extends TerraformStack {
  constructor(scope: Construct, id: string) {
    ...
    const awsProvider = new AwsProvider(this, "AWS", {
      region: "us-east-1",
      accessKey: "ASIAWPRT43PNBBWL3S7Q",
      secretKey: "fo7pQJvaHPbtE84bj+ckResLkS+yO12CRjnXC32E",
      token: ""
    });
    ...
    if (CLOUDWATCH_ENABLED)
    {
      ...
      if (cloudWatchLogsGroup.stringValue != defaultLogGroupName)
      {
        new CloudwatchLogGroup(this, `loggroup`, {
          name: defaultLogGroupName
        });
      }
...
telemetry:
  ...
  exporters:
    ...
    // Construct the SASL password string
